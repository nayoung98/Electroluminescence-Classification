...
def cell_clr(cell, clr, mask):
    ...
    return img_output
            # 투명한 사각형 그리기
            # cv2.rectangle(img, (left, upper), (right, lower), clr, -1)
...
#     # print(output[j])
#     mask = np.zeros((600, 300, 4), dtype=np.uint8)
...
#     # 투명한 사각형 그리기
#     cv2.rectangle(mask, (0, 0), (300, 600), clr, -1) 
#     output = overlay_transparent(cell, mask, 0, 0)
                        
# cv2.rectangle(mask, (500, 500), (500+500, 500+500), clr, -1) 
