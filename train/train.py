...
## Dataloader ##
train_dataset = ELmoduleCustomDataset(data_dir=data_dir, phase='train')
valid_dataset = ELmoduleCustomDataset(data_dir=data_dir, phase='valid')
...
for epoch in range(st_epoch+1, num_epoch+1):
    ...
    train_loss_list = train(model, loader_train, optim, criterion, device)
    ...
    with torch.no_grad():   
        ...
        y_true, y_pred, valid_loss_list = validate(model, loader_val, criterion, device)
